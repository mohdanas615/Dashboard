...
//       </button>
//       <div className="flex">
//         {isOpen && ( // Conditionally render the sidebar
...
//             <h1 className=" font-semibold text-4xl">My Cource</h1>
//             <h1 className=" font-normal text-xl my-3 ml-10 text-blue-500">
//               View All
//             </h1>
...
//                 (item.completed / item.totalLessons) * 100
//               );
//               return (
//                 <div
//                   key={index}
//                   className={`${item.color} rounded-lg p-4 h-[22vh] w-[48%]`}
//                 >
...
//                         root: {},
//                         path: {
//                           stroke: `#ffffff`, // Tailwind's blue-500
//                           strokeWidth: 8, // Adjust the stroke width as necessary
//                         },
//                         text: {
...
//               <FontAwesomeIcon
//                 icon={faCalendar}
//                 className="text-gray-500 mr-2" // Added margin for spacing
//               />
...
//               <div
//                 key={index}
//                 className="bg-gray-200 rounded-lg p-4 h-[12vh] flex flex-col justify-between"
//               >
//                 <div className="flex items-center">
//                   <div
//                     className={`${item.color} w-[8vh] h-[8vh] p-4 rounded-xl flex items-center justify-center`}
//                   >
//                     <FontAwesomeIcon icon={faBook} className="text-gray-700" />
//                   </div>

//                   <div className="flex flex-col">
//                     <h3 className="ml-3 font-semibold text-md">{item.title}</h3>
...
//               </div>
//               <FontAwesomeIcon icon={faChevronDown} className="ml-auto text-black-600 text-lg" />
//             </div>
//           </div>
...
// function Sidebar() {
//   const [isOpen, setIsOpen] = useState(false); // State to handle menu visibility on mobile

//   const lessonsData = [
//     { color: "bg-blue-400", title: "French", totalLessons: 35, completed: 26 },
//     { color: "bg-orange-400", title: "Portugese", totalLessons: 30, completed: 15 },
//     { color: "bg-green-400", title: "Italian", totalLessons: 20, completed: 5 },
//     { color: "bg-yellow-400", title: "German", totalLessons: 40, completed: 28 },
//   ];

//   const planningDetail = [
//     { color: "bg-blue-300", title: "Reading-Beginner Topic 1", time: "8:00 AM-10:00 AM" },
//     { color: "bg-orange-300", title: "Reading-Intermediate Topic 1", time: "1:00 PM-2:00 PM" },
//     { color: "bg-green-300", title: "Reading-Advanced Topic 1", time: "11:00 PM-12:00 PM" },
//     { color: "bg-yellow-300", title: "Reading-Beginner Topic 1", time: "1:00 PM-2:00 PM" },
//   ];

//   return (
//     <>
//       {/* Navbar for smaller screens */}
//       <div className="md:hidden flex justify-between items-center p-4 bg-blue-500 text-white">
//         <img 
//           src={`${process.env.PUBLIC_URL}/images/logo.png`} 
//           alt="Logo" 
//           className="w-8 h-8" 
...
//       {/* Sidebar for larger screens or collapsible menu for mobile */}
//       <div className={`flex ${isOpen ? "flex-col" : "hidden"} md:flex md:flex-row`}>
//         <div className="w-full md:w-[20vw] lg:w-[20%] h-[100vh] shadow-lg shadow-gray-500/50 flex flex-col items-center p-6 md:block bg-white">
//           <ul className="flex flex-col items-center space-y-10">
//             <li className="flex items-center">
//               <FontAwesomeIcon icon={faHome} className="mr-6 text-blue-500 text-lg" />
//               <span className="text-blue-500 text-lg">Overview</span>
//             </li>
//             <li className="flex items-center">
//               <FontAwesomeIcon icon={faTh} className="mr-6 text-gray-500 text-lg" />
//               <span className="text-gray-500 text-lg">Course</span>
//             </li>
//             <li className="flex items-center">
//               <FontAwesomeIcon icon={faBook} className="mr-6 text-gray-500 text-lg" />
//               <span className="text-gray-500 text-lg">Resource</span>
//             </li>
//             <li className="flex items-center">
//               <FontAwesomeIcon icon={faEnvelope} className="mr-6 text-gray-500 text-lg" />
//               <span className="text-gray-500 text-lg">Message</span>
//             </li>
//             <li className="flex items-center">
//               <FontAwesomeIcon icon={faCog} className="mr-6 text-gray-500 text-lg" />
//               <span className="text-gray-500 text-lg">Setting</span>
//             </li>
//           </ul>
//         </div>

//         {/* Main Content */}
//         <div className="flex-grow p-6 bg-white-200">
//           <h2 className="text-2xl font-bold mb-6 text-blue-500">Hello <strong>MOHD ANAS</strong>, welcome back!</h2>

//           {/* Courses Section */}
//           <div className="flex items-center">
//             <h1 className="font-semibold text-4xl">My Course</h1>
//             <h1 className="font-normal text-xl ml-10 text-blue-500">View All</h1>
//             <div className="flex items-center ml-auto">
...
//               return (
//                 <div key={index} className={`${item.color} rounded-lg p-4 h-[22vh] w-[48%]`}>
...
//                   <div className="flex items-center justify-center mt-3 mx-2" style={{ width: "50px", height: "50px" }}>
//                     <CircularProgressbar
//                       value={percentage}
//                       text={`${percentage}%`}
//                       styles={{
//                         path: { stroke: `#ffffff`, strokeWidth: 8 },
//                         text: { fill: "#ffffff", fontSize: "25px" },
//                         trail: { stroke: "#d9d9d9" },
//                       }}
//                     />
//                   </div>
...
//           <div className="grid grid-cols-2 gap-4">
//             {planningDetail.map((item, index) => (
//               <div key={index} className="bg-gray-200 rounded-lg p-4 h-[12vh] flex flex-col justify-between">
//                 <div className="flex items-center">
...
//           {/* Additional Statistics and Activity */}
//           <h1 className="text-4xl font-semibold my-8">Statistics</h1>
//           <div className="grid grid-cols-2 gap-4">
//             <div className="bg-blue-200 rounded-2xl p-4 h-[25vh] flex flex-col justify-between">
//               <h3 className="text-gray text-xl">Courses Completed</h3>
//               <p className="text-blue-500 text-4xl mt-2 ml-auto">1</p>
//             </div>
//             <div className="bg-blue-200 rounded-2xl p-4 h-[25vh] flex flex-col justify-between">
//               <h3 className="text-gray text-xl">Total Points Gained</h3>
...
//             </div>
//             <div className="bg-blue-200 rounded-2xl p-4 h-[25vh] flex flex-col justify-between">
//               <h3 className="text-gray text-xl">Courses In Progress</h3>
//               <p className="text-blue-500 text-4xl mt-2 ml-auto">3</p>
//             </div>
//             <div className="bg-blue-200 rounded-2xl p-4 h-[25vh] flex flex-col justify-between">
//               <h3 className="text-gray text-xl">Tasks Finished</h3>
//               <p className="text-blue-500 text-4xl mt-2 ml-auto">4</p>
//             </div>
//           </div>
//         </div>
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center p-4 shadow-md bg-white">
        <div className="flex items-center">
          ...
          <h2 className="text-5xl font-bold text-blue-500">
            S<span className="mr-2">E</span>
            <span className="relative">
              <span className="absolute -translate-x-1/2 -mt-3 text-blue-500 my">.</span>
            </span>
            T
          </h2>
        </div>
        ...
        <div className="flex items-center">
          ...
          {/* Notification and profile (only visible on larger screens) */}
          <div className="hidden md:flex items-center ml-4">
            <FontAwesomeIcon icon={faBell} className="text-gray-700 text-2xl mr-6" />
            <div className="flex items-center bg-blue-200 rounded-lg p-2 shadow-md">
              <img
                src="https://via.placeholder.com/50"
                alt="Profile"
      ...
      <div className="flex flex-col md:flex-row">
        {isOpen && (
           <div className={`w-full md:w-[20vw] lg:w-[20%] h-[150vh] shadow-lg shadow-gray-500/50 flex flex-col items-center p-6 ${isOpen ? 'block' : 'hidden md:block'}`}>
           {/* <div className="w-full md:w-[20vw] lg:w-[20%] h-[150vh] shadow-lg shadow-gray-500/50 flex flex-col items-center p-6"> */}
            <div className="flex">
              <img
                src={`${process.env.PUBLIC_URL}/images/logo.png`}
            ...
            <ul className="flex flex-col items-center space-y-10">
              ...
              <li className="flex items-center">
                <FontAwesomeIcon icon={faTh} className="mr-6 text-grey-500 text-lg" />
                <span className="text-grey-500 text-lg">Course</span>
              </li>
              <li className="flex items-center">
                <FontAwesomeIcon icon={faBook} className="mr-6 text-grey-500 text-lg" />
                <span className="text-grey-500 text-lg">Resource</span>
              </li>
              <li className="flex items-center">
                <FontAwesomeIcon icon={faEnvelope} className="mr-6 text-grey-500 text-lg" />
                <span className="text-grey-500 text-lg">Message</span>
              </li>
              <li className="flex items-center">
                <FontAwesomeIcon icon={faCog} className="mr-6 text-grey-500 text-lg" />
                <span className="text-grey-500 text-lg">Setting</span>
              </li>
            </ul>
        ...
        <div className="w-full md:w-3/5 lg:w-[50%] p-6 bg-white-200">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            {lessonsData.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`${item.color} rounded-lg p-4 h-[22vh] w-full md:w-[48%]`}
                >
                  <h3 className="text-white font-semibold text-xl">{item.title}</h3>
                  <span className="text-white text-sm">{item.totalLessons} lessons</span>
                  <div className="flex items-center justify-center mt-3 mx-2" style={{ width: "50px", height: "50px" }}>
  ...
  {planningDetail.map((item, index) => (
    ...
    >
      <div className="flex items-center">
        ...
        <div className="w-full lg:w-[30%] p-6 bg-white shadow-lg shadow-gray-500/50">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-blue-200 rounded-2xl p-4 h-[25vh] flex flex-col justify-between">
              <h3 className="text-gray text-xl">Cource In Progress</h3>
              <div className="flex items-center">
                <div className="h-7 mt-2 border-l-4 border-blue-500 rounded-full"></div>
                <p className="text-blue-500 text-4xl mt-2 ml-auto">3</p>
              </div>
